...
ActiveRecord::Schema[7.2].define(version: 2026_03_30_200000) do
  ...
  create_table "categories", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "ledger_usage", default: "personal", null: false
    t.index ["family_id", "ledger_usage", "name"], name: "index_categories_on_family_ledger_usage_and_name", unique: true
  ...
  create_table "recurring_transactions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.uuid "account_id"
    t.boolean "recurring_income", default: false, null: false
