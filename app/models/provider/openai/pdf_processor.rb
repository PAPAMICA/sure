  ...
  def instructions
    <<~INSTRUCTIONS.strip
      ...
      1. **Document Type**: Classify the document as one of the following:
         - `bank_statement`: A bank account statement showing transactions, balances, and account activity. This includes mobile money and digital wallet statements, and any statement showing a list of financial transactions with dates and amounts.
